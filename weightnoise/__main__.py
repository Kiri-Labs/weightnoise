...
def main():
    ...
    # ── compact ──
    compact_p = sub.add_parser("compact", help="Compress model via SVD factorization (actually reduces file size)")
    ...
    # ── COMpact ──
        ...
        print(f"  Matrices factorized: {stats['converted']}")
